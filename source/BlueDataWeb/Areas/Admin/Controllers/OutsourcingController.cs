...
namespace BlueDataWeb.Areas.Admin.Controllers
{
    ...
    public class OutsourcingController : BaseController
    {
        ...
        {
            var cate = db.NewCategories.Where(x => x.KeyName == "E_Outsourcing" && x.AppID == this.AppID).FirstOrDefault();
        ...
        {
            var cate = db.NewCategories.Where(x => x.KeyName == "E_Outsourcing").First();
