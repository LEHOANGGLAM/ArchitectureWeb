...
namespace BlueDataWeb.Areas.Admin.Controllers
{
    ...
    public class SanPhamController : BaseController
    {
        ...
        private string _keyName = NewsType.E_SanPham.ToString();
        ...
        {
            var cate = db.NewCategories.Where(x => x.KeyName == this._keyName && x.AppID == this.AppID).FirstOrDefault();
        ...
        {
            var cate = db.NewCategories.Where(x => x.KeyName == this._keyName).First();
