...
namespace BlueDataWeb.Controllers
{
    public class OutsourcingController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            NewCategory newcategory = db.NewCategories.AsNoTracking().Where(m => m.KeyName == "E_Outsourcing" && m.AppID == this.AppID).FirstOrDefault();
            ...
            return View("Outsourcing_Index", lstnew);
        }
