...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        type.Url = BaseUrl + "myfiles/files/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "myfiles/files/";
        type.MaxSize = 30485760;
        ...
        type.Url = BaseUrl + "myfiles/images/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "myfiles/images/";
        type.MaxSize = 10485760;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
		type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("Flash");
        type.Url = BaseUrl + "myfiles/flash/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "myfiles/flash/";
        type.MaxSize = 30485760;
